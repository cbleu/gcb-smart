...
<!-- ==========================CONTENT STARTS HERE ========================== -->
		...
		<header id="header">
			...
			<div id="logo-group">
				<span id="logo"> <img src=url::base(false)."img/EGP/logo.png" alt="SmartAdmin"> </span>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-7 col-lg-8 hidden-xs hidden-sm">
						...
						<div class="hero">
							...
							<img src=url::base(false)."img/demo/sa-demo.png" class="pull-right display-image" alt="" style="width:355px">
