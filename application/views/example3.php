...
<div class="navbar navbar-inverse navbar-fixed-top">
	<div class="navbar-inner">
		<div class="container">
			...
			<a class="brand" href="#">Kohana CRUD</a>
			<div class="nav-collapse collapse">
				<ul class="nav">
					<li><?php echo HTML::anchor("example/index", "Example 1"); ?></li>
					<li><?php echo HTML::anchor("example/example2", "Example 2"); ?></li>
					<li  class="active"><?php echo HTML::anchor("example/example3", "Example 3"); ?></li>
				</ul>
			</div>
			<!--/.nav-collapse -->
		</div>
